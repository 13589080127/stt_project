...
from os.path import exists   #检查文件是否存在    从os.path导入存在   exists将文件名字符串作为参 数，如果文件存在的话，它将返回 True，否则将返回 False
...
print "The input file is %d bytes long" % len(indata)    #把indata的值带入到%d？
